            ...
            <div class="mt-7 bg-gray-200  rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Create Permission</h1>
                    ...
                    <div class="mt-5">
                        <form @submit.prevent="savePermission">
                            <div class="grid gap-y-4">
                                <div>
                                    <label for="name"
                                        class="block text-sm font-bold ml-1 mb-2 dark:text-gray-200 text-gray-800">Permission</label>
                                    <div class="relative">
                                    ...
                                    <!-- <p class="hidden text-xs text-red-600 mt-2" id="email-error">Please include a valid Permission
                                    </p>
                                    {{ sameDataError }}
                                    <p v-if="sameData" class="hidden text-xs text-red-600 mt-2">Permission already exists
                                    </p> -->
                                </div>
                                <div>
                                ...
                                <div class="flex justify-between">
                                    ...
                                    Save</button>
                                <RouterLink :to="{ name: 'PermissionsIndex'}"
...
const { storePermission } = usePermissions();
