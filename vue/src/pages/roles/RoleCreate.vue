    ...
    <div>
        <main id="content" role="main" class="w-full max-w-md mx-auto p-6">
            <div class="text-start">
                <h1 class="block text-2xl font-bold text-gray-800  dark:text-gray-200 ">Create Role</h1>
                    ...
                    <div class="mt-5">
                        <form @submit.prevent="saveRole">
                            <div class="grid gap-y-4">
                                <div>
                                    <label for="name"
                                        class="block text-sm font-bold ml-1 mb-2 dark:text-gray-200 text-gray-800">Role</label>
                                    <div class="relative">
                                    ...
                                    <!-- <p class="hidden text-xs text-red-600 mt-2" id="email-error">Please include a valid Role
                                    </p>
                                    {{ sameDataError }}
                                    <p v-if="sameData" class="hidden text-xs text-red-600 mt-2">Role already exists
                                    </p> -->
                                </div>
                                <div>
